...
class MovieController extends AbstractController
{
    ...
    {
        return $this->render('movie/list.html.twig',['maVariableJusteAMoi'=>'Youhouuu ça marche ez ce truc']);
    }

    #[Route('/movie/random', name:'app_movie_random')]
    public function random(): Response
    {
        return new Response(content:'Film tiré au hasard', status: 200);
    }

    /**
     * Route qui prend en paramètre un id
     * id est uniquement un entier
     * 
     * htps://symfony.com/doc/current/routing.html#routing-route-parameters
     * 
     * @return Response
     */
    ...
    public function findOne(int $id): Response
    {
        ...
        return $this->render('movie/movie.html.twig', ['id'=>$id, 'titre'=>$titre, 'movie'=>$superMovie]);
    }
